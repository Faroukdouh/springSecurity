...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        final String authHeader = request.getHeader("Authorization"); //Authentication Authorization
        final String jwt;
        ...
        //SecurityContextHolder.getContext().getAuthentication() == null    càd user is not authenticated yet
